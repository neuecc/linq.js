...
Linq.Tools.String =
{
    ...
    {
        trimChars = (trimChars == null) ? " " : Linq.Tools.String.EscapeRegex(trimChars);
        var regex = new RegExp(Linq.Tools.String.Format("^[{0}]+|[{0}]+$", trimChars), "g");
    ...
    {
        trimChars = (trimChars == null) ? " " : Linq.Tools.String.EscapeRegex(trimChars);
        var regex = new RegExp(Linq.Tools.String.Format("^[{0}]+", trimChars), "g");
        return value.replace(regex, " ");
    },
...
// Obsolete : please use Linq.Tools.String.Format()
Linq.Tools.Template = function(template, replacement)
{
    Linq.Tools.String.Format(template, replacement);
}
...
Linq.Tools.StringBuilder.prototype =
{
    ...
    {
        var format = Linq.Tools.String.Format.apply(null, arguments);
